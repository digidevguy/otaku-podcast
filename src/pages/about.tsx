			...
			>
				...
				<VStack as='section' align='flex-start'>
					...
					<Text>
						...
						makes anime special, is that it&apos;s not just all about escapism.
						The lessons we learn from episode to episode can help us gain
					...
					<Text>
						...
						of study, firsthand experience, and a dash of comedy to keep the
				...
				<VStack as='section' align='flex-start'>
					...
					<Text>
						...
						“regular cartoons.” But looking back after all these years, I can
						honestly say that that movie was one of the few
						...
						she was frozen in place that made this movie special. Back then, all
						I knew was that it was pretty, it made me cry, it made me laugh, and
						it made me feel like I, too, could fly! (A theory that young Tiffany
						quickly disproved by jumping off of the couch on a broom and
						splitting her lip on a coffee table). I may not have understood
						exactly why that particular movie stood out, but I knew that from
					...
					<Text>
						...
						anime was right there – growing alongside me; With shows like Cowboy
						Bebop, Fruits Basket, and Full Metal Alchemist helping to give me a
					...
					<Text>
						...
						people. Hence, the reason for the EXO podcast and EXO community. The
						thing that makes me happiest in life is knowing that I&apos;ve
						...
						world and everything it has to offer. The least I can do is to share
						that knowledge in hopes that it helps even one other person while
						they&apos;re on their hero&apos;s journey.{' '}
					</Text>
					<Text>
						{' '}
						If you want to become a part of this growing community of freaks,
						geeks, and weebs subscribe to the podcast, follow me on my socials,
